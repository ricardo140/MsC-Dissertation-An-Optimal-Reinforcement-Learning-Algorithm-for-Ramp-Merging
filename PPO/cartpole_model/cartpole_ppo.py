    ...
    def learn(self, max_grad_norm):
        ...
        for _ in range(self.epochs):
            ...
            for batch in batches:
                states = torch.tensor(states_full[batch], dtype=torch.float32)
...
for episode in range(num_episodes):
    ...
    if average_reward > 195:
        ...
        torch.save(agent.actor.state_dict(), 'cartpole_model/ppo_actor.pth')
        torch.save(agent.critic.state_dict(), 'cartpole_model/ppo_critic.pth')
        break
...
plt.legend()
fig.savefig("cartpole_model/ppo_score.png")
...
# plt.legend()
# fig.savefig("cartpole_model/ppo_actor_loss.png")
...
# plt.legend()
# fig.savefig("cartpole_model/ppo_critic_loss.png")

actor_path = "cartpole_model/ppo_actor.pth"
critic_path = "cartpole_model/ppo_critic.pth"
agent = testAgent(state_n, action_n, actor_path, critic_path, num_cells)
env.reset()
...
# fig.savefig("cartpole_model/ppo_test_cartpole.png")

test_single_episode(agent, env, "cartpole_model/video")