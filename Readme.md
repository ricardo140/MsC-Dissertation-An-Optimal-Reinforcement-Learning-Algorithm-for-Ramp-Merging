...
- The PPO folder contains 4 items, the PPO implementation using jupyter, the environment desgined called traffic_env_working_cars.py with all 4 different environments,
  the agent trained and tested in the dissertation called actor_critic_gru_cars_480-510.pt and the readme file.
